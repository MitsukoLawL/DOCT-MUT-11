...
import fr.inria.gforge.spoon.mutation.OperatorMutator1;
...
import fr.inria.gforge.spoon.transformation.Racine;
...
public class MutationTesterTest {
	...
	public void testMutationTester() throws Exception {
		...
		String codeToBeMutated = "src/test/resources/fr/inria/gforge/spoon/transformation/A.java";
